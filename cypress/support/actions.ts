...
/************START***************************8
 * 
 * 1.Click elements based on Contains text
 * @param {Element} element
 */
 export const clickContainsElement = (element: string) => {
    cy.contains(element).click({ force: true});
    cy.wait(8000);
}

/**
 * 2.Click last element from list
 * @param {Element} element
 */
 export const clickLast = (element: string) => {
